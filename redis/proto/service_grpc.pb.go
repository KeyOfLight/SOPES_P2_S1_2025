...
const (
	WeatherService_SendWeatherData_FullMethodName = "/proto.WeatherService/SendWeatherData"
)
...
type WeatherServiceClient interface {
	SendWeatherData(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (*WeatherResponse, error)
}
...
func (c *weatherServiceClient) SendWeatherData(ctx context.Context, in *WeatherRequest, opts ...grpc.CallOption) (*WeatherResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WeatherResponse)
	err := c.cc.Invoke(ctx, WeatherService_SendWeatherData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WeatherServiceServer interface {
	SendWeatherData(context.Context, *WeatherRequest) (*WeatherResponse, error)
...
func (UnimplementedWeatherServiceServer) SendWeatherData(context.Context, *WeatherRequest) (*WeatherResponse, error) {
...
func _WeatherService_SendWeatherData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WeatherServiceServer).SendWeatherData(ctx, req.(*WeatherRequest))
	}
